...
////            String myuserid = request.getSession().getAttribute("userrid").toString();
            String taid = request.getParameter("tid").toString();
            System.err.println("--> HERE TID " +taid);
            String fromaid = request.getSession().getAttribute("userrid").toString();
//            System.out.println("=====taid======" + taid);
            System.err.println(  "From AID --> " + fromaid);
            
            
            // the mysql insert statement
            String query = " update tbl_association  set  status = 'Accept' where uid ='" + fromaid + "'and tid ='" + taid + "'";
